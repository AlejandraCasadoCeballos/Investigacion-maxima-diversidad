...
//        prepareFronts(minimizing, new String[]{pathSS+"/"+instanceName, pathPrev+"/"+instanceName}, pathOutRef);
    ...
    public static void evaluateDir() throws FileNotFoundException {
        ...
        String pathSSOriginal = "obnoxious/obp_vns";
        String pathSS = "obnoxious/jmetal/obp_vns";
        String pathPrevOriginal = "obnoxious/obp_lsao";
        String pathPrev = "obnoxious/jmetal/obp_lsao";
        String pathOutRef = "obnoxious/jmetal/reference";
        new File(pathOutRef).mkdirs();
//        new File("moflp/JMetal").mkdirs();

        try (PrintWriter pw = new PrintWriter("obp_analysis.csv")) {
