...
public class TestObnoxiousCalibracion {
...
//        prepareFronts(minimizing, new String[]{pathSS+"/"+instanceName, pathPrev+"/"+instanceName}, pathOutRef);
    ...
    public static void evaluateDir() throws FileNotFoundException {
        ...
        String pathGlobal = "./obnoxious2";
        String[] paths = new String[]{
                "RSVNS(ConstGRASP(1,-1.0),LS2RND(1,0.30),ConstGRASP(0,-1.0),LS2RND(0,0.50),LSAggRand(-1.0,0.50),10,1,0.05,0.1,10)",
                "lsao",
                "lsdb",
                "nsgaii",
                "spea2",
        ...
        boolean[] minimizing = new boolean[]{false, false};
        String pathJMetal = pathGlobal+"/jmetal";
        new File(pathJMetal).mkdirs();

        try (PrintWriter pw = new PrintWriter("opp_analysis.csv")) {
            String matching = "";
