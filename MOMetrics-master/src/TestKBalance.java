...
//        String pathGlobal = "/Users/jesus.sanchezoro/ResultadosInvestigacion/kbalanced/pareto";
        String pathGlobal = "/Users/jesus.sanchezoro/ResultadosInvestigacion/kbalanced/final/two_obj";
        String[] paths = new String[]{
//                "Parallel_SO(0.1,C1(0,0.50),C1(1,-1.00),C1(2,-1.00),LSF1(0.50),LSF2(0.50),33)",
                "Parallel_SO(0.1,C1(0,0.50),C1(1,-1.00),C1(2,-1.00),LSF1(1.00),LSF2(1.00),33)",
                "sota",
        };
        boolean[] minimizing = new boolean[]{true, true, true};
        String pathJMetal = pathGlobal+"/jmetal";
        new File(pathJMetal).mkdirs();

        try (PrintWriter pw = new PrintWriter("kbalanced_analysis.csv")) {
            String matching = "";
