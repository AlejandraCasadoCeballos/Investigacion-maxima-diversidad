...
public class TestObnoxious_SeveralRuns {
...
//        prepareFronts(minimizing, new String[]{pathSS+"/"+instanceName, pathPrev+"/"+instanceName}, pathOutRef);
    ...
    public static void evaluateDir() throws FileNotFoundException {
        String pathGlobal = "/Users/jesus.sanchezoro/OneDrive - Universidad Rey Juan Carlos/Universidad/Investigacion/Obnoxious PMedian/resultados_several_runs/RSVNS_SeveralRuns(ConstGRASP(1,-1.0),LS2RND(1,0.30),ConstGRASP(0,-1.0),LS2RND(0,0.50),LSAggRand(-1.0,0.50),10,1,0.05,0.1,10)";
        ...
        try (PrintWriter pw = new PrintWriter("opp_several_analysis.csv")) {
            String matching = "";
