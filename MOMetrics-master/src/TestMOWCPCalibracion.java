...
public class TestMOWCPCalibracion {
    ...
    public static void prepareFronts(boolean[] minimizing, String pathGlobal, String[] paths, String pathJmetal, String[] pathsOut, String instanceName, String pathOutRef) {
        ...
        for (int i = 0; i < paths.length; i++) {
            if (paths[i].contains("spea2")) {
                instanceName = instanceName.replace(".txt", "vrp.txt_result.csv");
            }
...
//        prepareFronts(minimizing, new String[]{pathSS+"/"+instanceName, pathPrev+"/"+instanceName}, pathOutRef);
    ...
    public static void evaluateDir() throws FileNotFoundException {
        //String pathGlobal = "/Users/jesussanchezoro/Dropbox/Universidad/Obnoxious_location_VNS_Grecia/resultados-moma";
//        String pathGlobal = "/Users/jesussanchezoro/Downloads/Pareto GR";
        String pathGlobal = "/Users/jesus.sanchezoro/Downloads/fronteras/resultados kMax";
        ...
        boolean[] minimizing = new boolean[]{true, true, true, true};
        String pathJMetal = pathGlobal+"/jmetal";
        new File(pathJMetal).mkdirs();

        try (PrintWriter pw = new PrintWriter("mowcp_analysis.csv")) {
            String matching = "";
            ...
            System.out.println(pathGlobal+"/"+paths[0]);
